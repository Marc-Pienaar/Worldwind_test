...
requirejs.config({
    ...
    paths: {
        ...
        // NASA WorldWind
        'worldwind': window.DEBUG ? 'src/worldwind' : 'https://files.worldwind.arc.nasa.gov/artifactory/web/0.9.0/worldwind.min'
    },
...
require([
    ...
    function (fixes, config, constants, pace, $) {
        ...
        WorldWind.configuration.baseUrl = "js/src/"//https://unpkg.com/worldwindjs@1.7.0/build/dist/";
